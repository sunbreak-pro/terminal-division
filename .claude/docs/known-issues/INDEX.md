...
| #                                      | タイトル                                             | Discovered | キーワード                                                                                |
| -------------------------------------- | ---------------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------- |
| [003](./003-claude-cli-stream-json.md) | Claude CLI stream-json プロトコル仕様 (Phase 0 検証) | 2026-04-29 | claude CLI, stream-json, --print, --session-id, --resume, OSC 0 banner, T3-5 Chat UI 前提 |
