...
const App: React.FC = () => {
  ...
  const { setActiveTerminal, splitTerminal, closeTerminal } = useTerminalActions()
  ...
  }, [activeTerminalId, splitTerminal, closeTerminal, canSplitNow, terminalCount, moveFocus])
